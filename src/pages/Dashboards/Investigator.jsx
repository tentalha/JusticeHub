...
import { getActiveFIRS, getAllCriminals, getAllFIRS, getClosedFIRS, getCompletedFIRS, getPendingFIRS } from "features";
...
export const Investigator = () => {
  ...
  const allFIRs = firState.firs;

  const invesActiveFIRs = allFIRs.filter((elem)=> elem.status === "active").length;
  const invesCompletedFIRs = allFIRs.filter((elem)=> elem.status === "completed").length;
  const invesClosedFIRs = allFIRs.filter((elem)=> elem.status=== "closed").length;
 ...
 const [donutState, setDonutState] = useState();
  ...
  }, [invesActiveFIRs, invesClosedFIRs, invesCompletedFIRs])
  ...
  return (
    ...
    >
      ...
      <div className="mx-3 my-4 h-full sm:mx-4 sm:my-2 md:mx-6 md:my-2 lg:mx-8 lg:my-2 xl:mx-20 xl:my-2" style={{ flex: '1 1 calc(50% - 1rem)', zIndex: 998 }}>
  ...
  <div className="flex">
    <h3 className="mt-16 ml-4 font-bold text-white text-4xl">{invesActiveFIRs}</h3>
    <Link to="/assignedFIRs" className="mt-20 ml-36 font-semibold text-white text-sm">
      View All
    </Link>
  </div>
</div>
...
<div className="mx-3 my-4 h-48 sm:mx-4 sm:my-2 md:mx-6 md:my-2 lg:mx-8 lg:my-2 xl:mx-2 xl:my-2" style={{ flex: '1 1 calc(50% - 1rem)', zIndex: 998 }}>
  ...
  <div className="flex">
    <h3 className="mt-16 ml-4 font-bold text-white text-4xl">{invesCompletedFIRs}</h3>
...
<div className="mx-3 my-4 h-48 sm:mx-4 sm:my-2 md:mx-6 md:my-2 lg:mx-8 lg:my-2 xl:mx-20 xl:my-2" style={{ flex: '1 1 calc(50% - 1rem)', zIndex: 998 }}>
  ...
  <div className="flex">
    <h3 className="mt-16 ml-4 font-bold text-white text-4xl">{invesClosedFIRs}</h3>
     ...
     <div className="flex mb-20">
      <div>
        <div className="flex mt-5">
          <div className="ml-20">
            <span className="font-custom font-semibold text-2xl text-gray-700">Nov</span><br></br><span className="ml-3 font-custom font-bold text-3xl">18</span><br></br><span className="font-custom font-semibold text-2xl text-gray-800">2023</span>
          </div>
          <div className=" p-5 mt-2 font-custom text-gray-500 text-sm">Israeli police crack down on Arab citizens expressing solidarity with Gaza
          ...
          <div className="flex mt-5">
          <div className="ml-20">
            <span className="font-custom font-semibold text-2xl text-gray-800">Nov</span><br></br><span className="ml-3 font-custom font-bold text-3xl">18</span><br></br><span className="font-custom text-gray-800 font-semibold text-2xl">2023</span>
          </div>
          <div className=" p-5 mt-2 font-custom text-gray-500 text-sm">Israeli police crack down on Arab citizens expressing solidarity with Gaza
          <hr className="mt-3"></hr>
          </div>
          ...
          <div className="flex mt-5">
          <div className="ml-20">
            <span className="font-custom font-semibold text-2xl text-gray-800">Nov</span><br></br><span className="ml-3 font-custom font-bold text-3xl">18</span><br></br><span className="font-custom font-semibold text-2xl text-gray-800">2023</span>
          </div>
          <div className=" p-5 mt-2 font-custom text-gray-500 text-sm">Israeli police crack down on Arab citizens expressing solidarity with Gaza
          <hr className="mt-3"></hr>
          </div>
