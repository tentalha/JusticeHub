...
export const PendingFIRs = () => {
  ...
  return (
    <div className="xl:flex-1 xl:overflow-y-auto xl:ml-52 xs:ml-0 lg:flex-1 lg:overflow-y-auto lg:ml-52 md:flex-1 md:overflow-y-auto md:ml-52 sm:flex-1 sm:overflow-y-auto sm:ml-52">
      ...
      <h1
        id="tagline"
        className=" mt-2 bg-gray-100 hover:text-white px-2 hover:bg-black py-1 rounded-2xl  sm:ml-0 sm:mr-0 text-sm sm:text-sm md:text-sm lg:text-sm font-bold font-custom text-center transform scale-100 hover:scale-95 transition-transform duration-300 ease-in-out"
      >
        Hey Admin, Below are the Pending FIRs, click on a link to see a detailed
        view. Pending FIRs are those to whom the investigator has not been
        assigned yet. Assign the investigator to make them an active FIR.
      </h1>
