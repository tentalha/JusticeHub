...
import { checkCriminalStatus } from 'features'
...
export const CheckCriminalStatus = () => {
  ...
  return (
    <div className="xl:flex-1 xl:overflow-y-auto xl:ml-52 xs:ml-0 lg:flex-1 lg:overflow-y-auto lg:ml-52 md:flex-1 md:overflow-y-auto md:ml-52 sm:flex-1 sm:overflow-y-auto sm:ml-52">
      ...
      >
        Hey Operator, In the module you can Check the criminal record of the
        complainant, just simply type the CNIC of the complainant in the below
        given form and click submit. You will be notified if there is any past
        criminal record of the complainant is present or not. Good Luck!
      </h1>
      <br></br>
      <br></br>
      <form>
        <h1 className="font-custom text-5xl font-bold text-center">
          Enter Complainant CNIC
        </h1>
      ...
      {response ? (
        <h1 className="font-custom text-xl font-bold text-center">
          {response}
        </h1>
      ) : null}
    </div>
