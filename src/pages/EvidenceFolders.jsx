...
export const EvidenceFolders = () => {
  ...
  const handleEvidenceTypeClick = (type) => {
    setEvidenceType(type);
    navigate("/evidences", { state: { evdType: type } });
  };
...
Hey Investigator, On this page you will find multiple folders, each folders has its own type of evidence. Different folders are present for files, pictures, audio and video. You can also upload new evidence on this page.
</h1>
<br></br>
          ...
          <div className="flex">
            <div>
              <img
                ...
                onClick={() => handleEvidenceTypeClick("Files")}
              />
            ...
            <div className="ml-20">
              <img
                className="h-56 w-56"
                src="./icons/folder.png"
                onClick={() => handleEvidenceTypeClick("Audios")}
              />
            ...
            <div className="ml-20">
              <img
                className="h-56 w-56"
                src="./icons/folder.png"
                onClick={() => handleEvidenceTypeClick("Videos")}
              />
            ...
            <div className="ml-20">
              <img
                className="h-56 w-56"
                src="./icons/folder.png"
                onClick={() => handleEvidenceTypeClick("Pictures")}
              />
              <h1 className=" text-xl font-custom text-black ml-20">Pictures</h1>
            </div>
          </div>
        </div>
      </div>
      {isModalOpen ? (
        <CreateEvidence isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
      ) : null}
    </div>
  );
};
