      ...
      <div class="container mx-auto px-4 lg:px-20 mb-20">
        <div class="w-full p-8 my-4 md:px-12 lg:w-full lg:pl-4 lg:pr-0 mr-auto rounded-2xl shadow-xl shadow-custom-blue">
          ...
          <div class="grid grid-cols-1 gap-5 gap-x-28 md:grid-cols-2 mt-5 pr-5">
            ...
            <div>
              <h1 class="w-full lg:w-full text-md bg-white mr-5 font-semibold placeholder:text-black text-gray-900 mt-2 p-2 rounded-lg focus:outline-none focus:shadow-outline">Date and Time: <span className=" text-gray-500">{elem.datetime}</span></h1>
            </div>

            <div>
              <h1 class="w-full lg:w-full text-md bg-white mr-5 font-semibold placeholder:text-black text-gray-900 mt-2 p-2 rounded-lg focus:outline-none focus:shadow-outline">Location of Incident: <span className=" text-gray-500">{elem.location}</span></h1>
            </div>

            <div>
              <h1 class="w-full lg:w-full text-md bg-white mr-5 font-semibold placeholder:text-black text-gray-900 mt-2 p-2 rounded-lg focus:outline-none focus:shadow-outline">Complainant CNIC: <span className=" text-gray-500">{elem.complainantCNIC}</span></h1>
            </div>

            <div>
              <h1 class="w-full lg:w-full text-md bg-white mr-5 font-semibold placeholder:text-black text-gray-900 mt-2 p-2 rounded-lg focus:outline-none focus:shadow-outline">Application Type: <span className=" text-gray-500">{elem.applicationType}</span></h1>
            </div>
                
            <div>
              <h1 class="w-full lg:w-full text-md bg-white mr-5 font-semibold placeholder:text-black text-gray-900 mt-2 p-2 rounded-lg focus:outline-none focus:shadow-outline">Complainant Phone Number: <span className=" text-gray-500">{elem.complainantPhone}</span></h1>
            </div>
          ...
          <div class="my-4 mr-5">
            <h1
              class="w-full h-full bg-white text-md border-gray-300  font-semibold placeholder:text-black text-gray-900 mt-2 p-1  rounded-lg focus:outline-none focus:shadow-outline"
            >
                Details/Description: <br></br> <span className=" text-gray-500">{elem.details}</span>
            </h1>
          </div>
            ...
            <div className="h-full">
              ...
              <div><h1 className="text-center text-xl font-custom font-semibold text-gray-900 ">No relevant Documents were given by the Complainant! </h1></div>
