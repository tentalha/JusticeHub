  ...
  return (
    <div className="xl:flex-1 xl:overflow-y-auto xl:ml-52 xs:ml-0 lg:flex-1 mb-20 lg:overflow-y-auto lg:ml-52 md:flex-1 md:overflow-y-auto md:ml-52 sm:flex-1 sm:overflow-y-auto sm:ml-52">
      <div className={`${isModalOpen || isUpdateModalOpen ? 'blur-sm' : ''}`}>
        ...
        >
          Hey {user?.name}, you can Check the Criminals Record of the
          Complainant. Make sure you enter the criminal status of the
          complainant while submitting the FIR.
        </h1>
        <br />
        <div className="flex">
          <div className="mr-5 ml-5 w-full h-96 relative overflow-hidden rounded-lg shadow-lg border border-gray-300 hover:shadow-xl transition-transform duration-300 transform hover:scale-105 mb-20">
            ...
            <div className="mt-10 absolute flex items-center ml-3 w-96">
              <h1 className="ml-10 font-bold font-custom text-left text-6xl text-white">
                List of <span className="text-7xl text-red-600">Criminals</span>{' '}
                is Below, Check it out.
              </h1>
              <br />
              <br />
            </div>
        ...
        {criminals && criminals.length > 0 ? (
                        ...
                        <div className="flex mt-2">
                          <button
                            onClick={() => {
                              ...
                              dispatch(deleteCriminal(criminal._id)).then(
                                () => {
                                  navigate('/manageCriminals')
                                },
                              )
                            }}
                            className="w-full p-1 text-white bg-red-400 rounded-2xl shadow-lg font-bold font-custom"
                          >
                            Delete
                          </button>
                          <button
                            onClick={() => {
                              ...
                              setCriminalId(criminal._id)
                            }}
                            className="w-full p-1 text-white bg-blue-400 rounded-2xl shadow-lg ml-5 font-bold font-custom"
                          >
                            Edit
                          </button>
                        </div>
          ...
          <div>
            <h1 className="text-center text-2xl mb-10 mt-10 font-custom font-semibold ">
              Currently There Are No CRIMINALS To Show.
            </h1>
          </div>
        )}
      </div>
