...
export const OperatorFIRs = () => {
  ...
  Hey Operator, Below are the FIRs that you have created, you can only see the information of the FIRs that you are supposed to see. Regardless of the status of the FIRs i.e; pending, completed, active or closed all the FIRs are below. Good Luck!
</h1>
