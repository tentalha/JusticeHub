  ...
  return (
    <div className="xl:flex-1 xl:overflow-y-auto xl:ml-52 xs:ml-0 lg:flex-1 lg:overflow-y-auto lg:ml-52 md:flex-1 md:overflow-y-auto md:ml-52 sm:flex-1 sm:overflow-y-auto sm:ml-52">
      <div className={`${isModalOpen ? 'blur-sm' : ''}`}>
        ...
        >
          Hey Operator, Below are the FIRs that you have created, you can only
          see the information of the FIRs that you are supposed to see.
          Regardless of the status of the FIRs i.e; pending, completed, active
          or closed all the FIRs are below. Good Luck!
        </h1>
