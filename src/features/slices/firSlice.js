...
const firSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getAllFIRS.fulfilled, (state, { payload: { payload } }) => {
    ...
    builder.addCase(getAllFIRS.rejected, (state) => {
      state.loading = false;
    });
    builder.addCase(
      getPendingFIRS.fulfilled,
    ...
    builder.addCase(getPendingFIRS.rejected, (state) => {
      state.loading = false;
    });
    builder.addCase(
      getActiveFIRS.fulfilled,
      (state, { payload: { payload } }) => {
    ...
    builder.addCase(getActiveFIRS.rejected, (state) => {
      state.loading = false;
    });
    builder.addCase(
      getCompletedFIRS.fulfilled,
      (state, { payload: { payload } }) => {
    ...
    builder.addCase(getCompletedFIRS.rejected, (state) => {
      state.loading = false;
    });
    builder.addCase(
      getClosedFIRS.fulfilled,
      (state, { payload: { payload } }) => {
    ...
    builder.addCase(getClosedFIRS.rejected, (state) => {
      state.loading = false;
    });
    ...
    builder
      .addCase(approveFir.rejected, (state) => {
        state.loading = false;
      })
