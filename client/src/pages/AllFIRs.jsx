...
export const AllFIRs = () => {
  ...
  return (
    <div className="xl:flex-1 xl:overflow-y-auto xl:ml-52 xs:ml-0 lg:flex-1 lg:overflow-y-auto lg:ml-52 md:flex-1 md:overflow-y-auto md:ml-52 sm:flex-1 sm:overflow-y-auto sm:ml-52">
      ...
      <br />
      <h1 className="bg-gray-100 p-5 rounded-2xl mx-4 sm:mx-0 text-sm font-bold font-custom text-center">
  Hey Admin, Below are the Pending FIRs, click on a link to see a detailed view. Pending FIRs are those to whom the investigator has not been assigned yet. Assign the investigator to make them an active FIR.
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg mx-2 md:mx-5 lg:mx-10 xl:mx-20">
    ...
    <table className="w-full text-sm text-left text-gray-600 "> 
        ...
        <tbody>
            <tr class="bg-white border-b">
                ...
                <td class="px-6 py-8">
                    <Link to="/firDetail"  class="font-medium text-blue-600 hover:underline">Click For Details</Link>
                </td>
            </tr>
            <tr class="bg-white border-b">
                <th scope="row" class="px-6 py-8 font-medium text-gray-900 whitespace-nowrap">
